 ...
 */
public class Autos extends Especificaciones_Tecnicas {

    public Autos (int codigo_unico, String tipo, String marca, String modelo, int año, double kilometraje, String patente){
